    ...
    <footer className="bg-base-200">
      <div className="footer m-auto max-w-7xl p-10 text-base-content">
        <nav className="space-y-2">
          ...
          <a href="mailto:s.vahkevych@gmail.com" className="link-hover link">
            s.vahkevych@gmail.com
          </a>
          <a href="tel:+1234567890" className="link-hover link">
            +1 (234) 567-890
          </a>
        </nav>
        <nav className="space-y-2">
      ...
      <div className="border-tm-auto footer m-auto max-w-7xl px-10 py-4 text-base-content">
